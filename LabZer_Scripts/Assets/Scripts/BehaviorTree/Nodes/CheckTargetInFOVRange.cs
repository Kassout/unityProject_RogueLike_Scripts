...
/// <summary>
/// Class <c>CheckTargetInFOVRange</c> is a BehaviorTree <c>Node</c> used to define a check for player in field of view range behavior.
/// </summary> 
public class CheckTargetInFOVRange : Node
{
    ...
    /// Default Constructor.
    /// </summary>
    public CheckTargetInFOVRange(Transform transform, float fieldOfViewRange, LayerMask whatIsPlayer)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (collider != null)
        {
            parent.SetData("tempTarget", collider.gameObject);
        ...
        else if (GetData("tempTarget") != null)
        {
            ClearData("tempTarget");
