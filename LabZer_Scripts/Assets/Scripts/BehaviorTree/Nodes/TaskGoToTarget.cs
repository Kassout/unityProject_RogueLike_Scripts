...
/// <summary>
/// Class <c>TaskGoToTarget</c> is a BehaviorTree <c>Node</c> used to define a go to target task behavior.
/// </summary>
public class TaskGoToTarget : Node
{
    ...
    /// <summary>
    /// Instance field <c>isMoving</c> represents the is moving status of the game object.
    /// </summary>
    ...
    /// Default Constructor.
    /// </summary>
    public TaskGoToTarget(Transform transform, float moveSpeed, PathFinder pathFinder)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (!_isMoving)
        {
            ...
            _updatePathCoroutine = Timing.RunCoroutine(UpdatePath(target.transform).CancelWith(_transform.gameObject));
