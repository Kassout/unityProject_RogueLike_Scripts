...
/// <summary>
/// Class <c>BlackGuardianBT</c> is a BehaviorTree <c>Tree</c> instance representing the general behavior of a black guardian game object.
/// </summary>
public class BlackGuardianBT : EnemyBT
{
    #region Fields / Properties

    /// <summary>
    /// Instance field <c>moveSpeed</c> represents the movement speed value of the black guardian game object.
    /// </summary>
    [SerializeField]
    private float _moveSpeed = 2f;

    /// <summary>
    /// Instance field <c>chasingFOVRange</c> represents the chasing range value of the field of view of the black guardian game object.
    /// </summary>
    [SerializeField]
    ...
    /// <summary>
    /// Instance field <c>gunTransform</c> is a Unity <c>Transform</c> component representing the position, rotation and scale of the gun of the black guardian game object.
    /// </summary>
    [SerializeField]
    private Transform _gunTransform;

    /// <summary>
    /// Instance field <c>shotRate</c> represents the fire shot frenquency value of the black guardian game object.
    /// </summary>
    [SerializeField]
    private float _shotRate;

    /// <summary>
    /// Instance field <c>bulletSpawner</c> is a BulletEngine <c>BulletSpawner</c> component representing the bullet spawner manager of the black guardian game object.
    /// </summary>
    private BulletSpawner _bulletSpawner;

    /// <summary>
    /// Instance field <c>animator</c> is a Unity <c>Animator</c> component representing the black guardian game object animator.
    /// </summary>
